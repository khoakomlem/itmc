...
export function ItemCard(props: ItemCardProps): JSX.Element {
  return (
    <div className='divide-gray-200 rounded-lg bg-white text-center shadow-lg h-[400px] ml-8 min-w-[300px]'>
      <div className='relative flex flex-1 flex-col items-center h-[65%] bg-[#1C74A6]'>
        <Image
          fill
          alt='Activity1'
          src='/Activity1.png'
